package ru.ruselprom.fet.extrusions.add;
...
public class ExtrusionAddRef {
	public void build(String newFeatName, String refSecName, ModelItem firstItem, ModelItem secondItem, Solid currSolid)  throws jxthrowable {
		...
		Selection firstRef = pfcSelect.CreateModelItemSelection(firstItem, null);
		Selection secondRef = pfcSelect.CreateModelItemSelection(secondItem, null);
	    ...
	    Element elem_1_5 = wfcElementTree.Element_Create(wfcElemIds.PRO_E_REMOVE_MATERIAL, pfcArgument.CreateIntArgValue(-1),1);			//PRO_EXT_MATERIAL_ADD = -1
	    ...
	    Element elem_3_0 = wfcElementTree.Element_Create(wfcElemIds.PRO_E_EXT_DEPTH_FROM_TYPE, pfcArgument.CreateIntArgValue(1 << 11),3);	//PRO_EXT_DEPTH_FROM_REF = (1 << 11)				
	    elements.append(elem_3_0);
	    
	    //PRO_E_EXT_DEPTH_FROM_REF
	    Element elem_3_1 = wfcElementTree.Element_Create(wfcElemIds.PRO_E_EXT_DEPTH_FROM_REF, pfcArgument.CreateSelectionArgValue(firstRef),3);
	    ...
	    Element elem_3_2 = wfcElementTree.Element_Create(wfcElemIds.PRO_E_EXT_DEPTH_TO_TYPE, pfcArgument.CreateIntArgValue(1 << 22),3);		//PRO_EXT_DEPTH_TO_REF = (1 << 22)
	    elements.append(elem_3_2);
	    
	    //PRO_E_EXT_DEPTH_TO_REF
	    Element elem_3_3 = wfcElementTree.Element_Create(wfcElemIds.PRO_E_EXT_DEPTH_TO_REF, pfcArgument.CreateSelectionArgValue(secondRef),3);	
