...
public class ExtrusionAddSym extends CreoObject {
    ...
    public void modelBuild(int depth, String newFeatName, String refSecName, Solid currSolid)  throws jxthrowable {
		try {
		    ...
		    Element elem_3_0 = wfcElementTree.Element_Create(wfcElemIds.PRO_E_EXT_DEPTH_FROM_TYPE, pfcArgument.CreateIntArgValue(1 << 7),3);	//PRO_EXT_DEPTH_FROM_BLIND = (1 << 7)	
		    ...
		    Element elem_3_2 = wfcElementTree.Element_Create(wfcElemIds.PRO_E_EXT_DEPTH_TO_TYPE, pfcArgument.CreateIntArgValue(1 << 28),3);		//PRO_EXT_DEPTH_SYMMETRIC = (1 << 28)
