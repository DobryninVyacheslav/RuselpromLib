...
public class RotatPatternSetNum extends AbstractRotatPattern {
    ...
    public RotatPatternSetNum(String refAxisName, Session session) {
    ...
    public void patternBuild(int numItems, double angleBetweenMembers, int dirOfRotat, String newFeatName, String refFeatName, Solid currSolid) throws jxthrowable {
		try {
		    ...
		    Element elem_2_1 = wfcElementTree.Element_Create(wfcElemIds.PRO_E_GENPAT_AXIS1_INC,pfcArgument.CreateDoubleArgValue(angleBetweenMembers),2);		//Axis 1st Increment (PRO_VALUE_TYPE_DOUBLE)
			...
			session.UIShowMessageDialog("Error creating rotating pattern!", null);
		}
